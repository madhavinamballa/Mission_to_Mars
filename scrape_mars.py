...
def scrape():
    news_title, news_paragraph = mars_news(init_browser)

    # Run all scraping functions and store in dictionary.
    data = {
        "news_title": news_title,
        "news_paragraph": news_paragraph,
        "featured_image": featured_image(init_browser),
        "hemispheres": hemispheres(init_browser),
        "weather": twitter_weather(init_browser),
        "facts": mars_facts(),
        "last_modified": dt.datetime.now()
    }

def mars_news(init_browser):
...
def featured_image(init_browser):
...
def twitter_weather(init_browser):
